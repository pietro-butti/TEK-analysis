...
wflowN1 = TEK_flow('HYDRA/nfh/n361b0350k7hf1825')
wflowN2 = TEK_flow('HYDRA/nfh/n289b0350k5hf1825')
time = wflowN1.time

'''
correction = -0.6111526*(8*time/289)**2 + 0.490510*np.exp(-1.10238*289**2/(8*time)**2)

plt.plot(wflowN1.t2E)
plt.plot(wflowN1.t2E-correction,label='corrected')
...
deltaphi = gv.gvar(wflowN1.t2E,wflowN1.jkk_sigma(binsize=10)) - gv.gvar(wflowN2.t2E,wflowN2.jkk_sigma(binsize=10))
